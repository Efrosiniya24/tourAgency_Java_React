    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .requestMatchers(HttpMethod.GET, "/tourAgency/admin/quantityOfOrders/**").authenticated()
                        .requestMatchers(HttpMethod.GET,"tourAgency/admin/quantityOfAllUsers").hasAuthority("ADMIN")
                        .requestMatchers(HttpMethod.GET, "tourAgency/admin/averageAgeClient").hasAuthority("ADMIN")
                        .requestMatchers(HttpMethod.GET, "tourAgency/admin/averageAgeFemale").hasAuthority("ADMIN")
                        .requestMatchers(HttpMethod.GET, "tourAgency/admin/averageAgeMale").hasAuthority("ADMIN")
                        .requestMatchers(HttpMethod.GET, "tourAgency/admin/percentageOfMale").hasAuthority("ADMIN")
                        .requestMatchers(HttpMethod.GET, "tourAgency/admin/percentageOfFemale").hasAuthority("ADMIN")
                        ...
                        .requestMatchers(HttpMethod.GET, "/tourAgency/orders/getOrders/**").authenticated()
                        .requestMatchers(HttpMethod.GET, "tourAgency/tours/popularTours").authenticated()
